          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="mb-12 bg-muted/30 border border-border rounded-lg p-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Maison du Bar O.E. ("we," "us," or "our") does not use any cookies on our website <a href="https://maisondubar.com" className="text-foreground underline hover:opacity-70">https://maisondubar.com</a>. This includes essential cookies, functional cookies, analytics cookies, marketing cookies, and any other type of cookie or similar tracking technology.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Under the General Data Protection Regulation (GDPR) and the EU ePrivacy Directive, cookie consent banners are only required when a website uses cookies that require user consent (such as analytics, advertising, or non-essential cookies).
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Since our website does not use any cookies whatsoever, no cookie consent banner is required or displayed. This approach ensures a cleaner browsing experience while remaining fully compliant with EU regulations.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                When you submit our contact form, your information is processed entirely server-side. The contact form does not set any cookies on your device.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Specifically:
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <li>Your form data is transmitted directly to our email service without storing anything in your browser</li>
              </ul>
              <p className="text-muted-foreground leading-relaxed mt-4">
                For information about how we handle the personal data you submit through the contact form, please refer to our <a href="/privacy-policy" className="text-foreground underline hover:opacity-70">Privacy Policy</a>.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                To be clear, our website does not employ:
              </p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                <li><strong className="text-foreground">Analytics Cookies:</strong> No Google Analytics, Hotjar, or similar tools</li>
                <li><strong className="text-foreground">Marketing/Advertising Cookies:</strong> No tracking for advertising purposes</li>
                <li><strong className="text-foreground">Social Media Cookies:</strong> No Facebook Pixel, Meta tracking, or similar technologies</li>
                <li><strong className="text-foreground">Performance Cookies:</strong> No data collection about website performance or user behavior</li>
                <li><strong className="text-foreground">Session Cookies:</strong> No cookies to maintain user sessions</li>
                <li><strong className="text-foreground">Local Storage/Session Storage:</strong> No browser storage mechanisms for tracking</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground leading-relaxed">
                We may update this Cookie Policy from time to time. When we make changes, we will update the "Effective Date" at the top of this page. We encourage you to review this policy periodically to stay informed about our practices.
              </p>
            </div>
