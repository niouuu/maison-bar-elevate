  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center max-w-6xl mx-auto">
            <div className="order-2 lg:order-1">
              <h2 className="font-playfair text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-primary-foreground">
                Our Mission
              </h2>
              <p className="text-base sm:text-lg text-primary-foreground/80 leading-relaxed mb-4 sm:mb-6">
            ...
            <div className="relative order-1 lg:order-2">
              <img
                ...
                className="rounded-lg shadow-2xl grayscale-hover w-full max-w-md mx-auto lg:max-w-none"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-secondary" ref={ref}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-playfair text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-10 sm:mb-12 md:mb-16 text-secondary-foreground">
            Why Choose Us
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            {differentiators.map((item, index) => (
              <motion.div
                ...
                className="bg-card p-6 sm:p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border border-border"
              >
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <CheckCircle2 className="text-accent flex-shrink-0 mt-1" size={24} />
                  <div>
                    <h3 className="font-playfair text-xl sm:text-2xl font-semibold mb-2 sm:mb-3 text-card-foreground">
                      {item.title}
                    </h3>
